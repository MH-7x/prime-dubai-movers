...
export default function UFCTASection({
  heading,
  body,
  city,
      ...
      <div className="relative max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
        ...
        <div className="flex flex-col sm:flex-row gap-4 justify-center">
          <a
            ...
            className="inline-flex items-center justify-center gap-2.5 bg-[#1E3A5F] hover:bg-[#162d4a] text-white font-bold px-8 py-4 rounded-xl transition-all duration-200 hover:shadow-xl text-base"
          >
