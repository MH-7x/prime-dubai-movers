...
const loc = getUFLocationBySlug("used-furniture-buyers-al-ain");
...
import heroImage from "../../../../public/fur/used-furniture-buyers-in-al-ain.jpg";

export default function UsedFurnitureBuyersAlAinPage() {
  if (!loc) notFound();
  ...
  const localBusinessSchema = {
    "@context": "https://schema.org",
    "@type": "LocalBusiness",
    name: "Al Ain Used Furniture Buyers",
    description: loc.metaDescription,
    url: `${process.env.APP_URL}${loc.canonicalPath}`,
  ...
  return (
    <>
      ...
      />
      <UFIntroSection
        img="/fur/buy-and-sell-used-furniture-in-al-ain.jpg"
