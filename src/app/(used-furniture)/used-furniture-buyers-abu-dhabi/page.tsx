...
const loc = getUFLocationBySlug("used-furniture-buyers-abu-dhabi");
...
import heroImage from "../../../../public/fur/used-furniture-buyers-in-abu-dhabi.jpg";
export default function UsedFurnitureBuyersAbuDhabiPage() {
  if (!loc) notFound();
  ...
  const localBusinessSchema = {
    "@context": "https://schema.org",
    "@type": "LocalBusiness",
    name: "Used Furniture Buyers in Abu Dhabi",
    description: loc.metaDescription,
    url: `${process.env.APP_URL}${loc.canonicalPath}`,
  ...
  return (
    <>
      ...
      />
      <UFIntroSection
        img="/fur/buy-and-sell-used-furniture-in-abu-dhabi.jpg"
