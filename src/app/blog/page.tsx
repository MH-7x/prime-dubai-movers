...
const blogPosts = [
  {
    ...
    excerpt: "A comprehensive breakdown of moving costs across Dubai neighborhoods, from studio apartments to large villas. Discover what factors affect pricing and how to budget for your next move.",
    date: "March 5, 2026",
    category: "Cost Guide",
  ...
  },
  {
    ...
    excerpt: "Your ultimate step-by-step moving checklist covering everything from 8 weeks before your move to settling into your new home. Never forget a critical task again.",
  ...
  },
  {
    ...
    excerpt: "Key factors to evaluate when selecting a moving company in Dubai. Learn about licensing, insurance, reviews, pricing transparency, and red flags to watch out for.",
  ...
  },
  {
    ...
    excerpt: "Practical strategies to save money on your next move without compromising quality. From timing your move right to decluttering effectively, these tips can save you hundreds.",
  ...
  },
  {
    ...
    excerpt: "A specialized guide for villa relocations in Dubai covering garden furniture, large appliances, pool equipment, and the unique challenges of community-based villa moves.",
  ...
  },
  {
    ...
    excerpt: "Minimize downtime and ensure business continuity during your office move. Expert advice on IT equipment handling, employee communication, and phased relocation strategies.",
      ...
      <section className="bg-navy text-white py-16 md:py-20">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <p className="text-gray-300 text-lg max-w-2xl">
            Expert advice from Dubai&apos;s trusted movers to help you plan, budget, and execute a stress-free relocation.
          </p>
        </div>
      </section>
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-8">
            {blogPosts.map((post, idx) => (
              <Card key={idx} className="border-0 shadow-sm hover:shadow-lg transition-shadow overflow-hidden group">
                ...
                <div className="bg-gray-200 w-full h-52 flex items-center justify-center text-gray-500 text-sm">
                  <span className="px-4 text-center">Placeholder: {post.alt}</span>
                </div>
          ...
          <div className="text-center mt-16 py-10 bg-off-white rounded-2xl">
            ...
            <p className="text-body max-w-lg mx-auto">
              We are working on more helpful guides covering moving costs, area guides, packing tips, and relocation advice for every UAE emirate.
            </p>
          </div>
        </div>
      </section>
      ...
      <section className="py-16 md:py-20 bg-navy text-white">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
          ...
          <p className="text-gray-300 text-lg mb-8 max-w-2xl mx-auto">
            Get a free, no-obligation quote from Dubai&apos;s most trusted movers and packers.
          </p>
