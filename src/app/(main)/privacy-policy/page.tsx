    ...
    <>
      ...
      <section className="py-12 md:py-16">
        <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 prose prose-gray max-w-none">
          ...
          <h3 className="text-xl font-extrabold text-navy mt-6 mb-3">
          ...
          <ul className="list-disc pl-6 text-body space-y-2 mb-4">
            ...
            <li>
              Communicate with you about your move, including confirmations and
              updates
            </li>
          ...
          <ul className="list-disc pl-6 text-body space-y-2 mb-4">
            ...
            <li>
              ...
              property, or safety of Prime Dubai Movers, our customers, or
              others
            </li>
          </ul>
          ...
          <p className="text-body leading-relaxed mb-4">
            ...
            stored on your device that help us understand how you use our
            website. We use:
          </p>
          <ul className="list-disc pl-6 text-body space-y-2 mb-4">
            <li>
          ...
          <p className="text-body leading-relaxed mb-4">
            ...
            legal, accounting, or reporting requirements. Quote request data is
            retained for up to 12 months. Completed service records are retained
            for up to 7 years in accordance with UAE commercial regulations.
          </p>
          ...
          <p className="text-body leading-relaxed mb-4">
            ...
            Maps, social media platforms, and review sites. We are not
          ...
          <p className="text-body leading-relaxed mb-4">
            ...
            a revised &quot;Last Updated&quot; date. Your continued use of our
            website after such modifications constitutes acceptance of the
            updated policy.
          </p>
